...
const PARSED_DATABASE_URL = parseDatabaseUrl(process.env.DATABASE_URL || "");
 ...
 * - 2025-11-25: 최신 협상 버전. 현재 서버는 tools/prompts/resources capability만 광고
 */
...
export const ACCESS_KEY         = process.env.ENGRAM_ACCESS_KEY || "";
...
export const NLI_DISABLE_INPROCESS = process.env.NLI_DISABLE_INPROCESS === "true";

/** 데이터베이스 설정 (PostgreSQL) - POSTGRES_* 우선, DB_* 호환 */
export const DATABASE_URL       = process.env.DATABASE_URL || "";
export const DB_HOST            = process.env.POSTGRES_HOST || process.env.DB_HOST || PARSED_DATABASE_URL?.host || "";
export const DB_PORT            = Number(process.env.POSTGRES_PORT || process.env.DB_PORT || PARSED_DATABASE_URL?.port || 5432);
export const DB_NAME            = process.env.POSTGRES_DB || process.env.DB_NAME || PARSED_DATABASE_URL?.database || "";
export const DB_USER            = process.env.POSTGRES_USER || process.env.DB_USER || PARSED_DATABASE_URL?.user || "";
export const DB_PASSWORD        = process.env.POSTGRES_PASSWORD || process.env.DB_PASSWORD || PARSED_DATABASE_URL?.password || "";

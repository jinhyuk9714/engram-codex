...
export const PROMPTS = [
  ...
  {
    name: "onboarding",
    description: "Engram Codex 기억 시스템 사용법을 안내합니다.",
    arguments: []
  }
];
        ...
        messages: [
          {
            ...
            content: {
              type: "text",
              text: `Engram Codex를 Codex에서 어떻게 사용하면 좋을지 설명해줘. 
특히 'remember', 'recall', 'reflect'라는 세 가지 핵심 도구를 언제 쓰는지, 그리고 AGENTS.md에 어떤 규칙을 두면 재사용하기 좋은지 예시와 함께 알려줘.`
            }
          }
        ]
      };
